    ...
    return (
        <div className="px-12">
            <div className="flex flex-col mb-8">
                <h4 className="text-sm leading-normal text-foreground-3 mb-1">Upload documents (Optional)</h4>
                <h6 className="text-2xl leading-normal font-semibold text-primary">Upload documents as appropriate, please note each field title</h6>
            </div>
