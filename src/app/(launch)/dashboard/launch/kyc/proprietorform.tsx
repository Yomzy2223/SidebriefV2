			...
			<form className="flex flex-col gap-12 items-start">
				<div className="flex flex-col gap-6 w-full">
					...
					<div className="flex flex-col gap-2">
						<Label
							htmlFor="name"
							value="Enter Name (Surname first)"
						/>
					...
					<div className="flex gap-2 items-center">
						...
						<Label htmlFor="is-director">
							Click here if shareholder is also a{" "}
					...
					<div className="flex gap-2 items-start">
						...
						<Label htmlFor="self-fill">
							Click here to ask Omolara to fill the required
							documents{" "}
							<span className="text-primary">
								(NIN, passport, statement of account)
							</span>
						</Label>
					</div>
				</div>
