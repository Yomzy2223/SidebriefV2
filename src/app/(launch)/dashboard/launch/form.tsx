    ...
    <form className="flex flex-col gap-20 items-start">
      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium leading-normal">
          To register your business, you must give your business a unique name,
          type it in the space here.
        </p>
        <TextInput placeholder="Enter your business name here" />
      </div>
      <div className="flex flex-col gap-2">
        <p className="text-sm font-medium leading-normal">
          We will need your business objectives to successfully register your
          business (4).
        </p>
