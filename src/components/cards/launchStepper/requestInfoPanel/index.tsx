...
const faqData:FaqDataProps[] = [
	{
	  ...
	  description: "National Identification Number is a 10-digit number commonly used in certain African countries such as Nigeria as a means of identification, you can get this from any of the officially accredited governmental parastatal.",
	},
	{
	...
	},
	{
		...
		"description": "To ensure tax compliance, individuals and businesses should keep accurate financial records, stay informed about tax laws and regulations, and seek professional assistance if needed. Additionally, timely filing of tax returns and payment of taxes owed is crucial."
	  },
	{
	"header": "What Are Common Tax Compliance Issues?",
	"description": "Common tax compliance issues include underreporting of income, claiming improper deductions or credits, failure to file tax returns, and late payment of taxes owed. These issues can result in penalties, interest charges, and other consequences."
	}
  ];
